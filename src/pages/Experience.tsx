    ...
    () => [
      {
        ...
        title: "Full-Stack Developer / AI Agentic Engineer",
        start: "2026-04-01",
        current: true,
        logo: "/images/companies/hexacode_logo.png",
        details: [
          "Developed and enhanced an on-premise agentic AI platform for enterprise banking use cases, including SLIK audit preparation, DWH form generation, workflow automation, and document-based knowledge retrieval.",
          "Built and maintained client-facing dashboard features using SvelteKit and Go, including workflow nodes, DWH form generator modules, and configurable prompt/rule-driven automation flows.",
          "Integrated local LLM and RAG-based services into banking workflows, translating audit requirements, SEOJK/SLIK rules, and data mapping logic into structured prompts, validation steps, and tool-based execution flows.",
          "Containerized and deployed agentic services with Docker/Docker Compose, Uvicorn/FastAPI-style services, GPU-enabled runtime configuration, environment management, and internal API connectivity.",
          "Operated and troubleshot applications in a MicroK8s environment, handling pods, services, ingress, port-forwarding, image builds/exports, disk pressure issues, and deployment/runtime failures on Linux servers.",
          "Worked directly with enterprise stakeholders to clarify requirements, analyze DWH endpoint sufficiency, and convert business/audit processes into executable technical workflows.",
        ],
      },
      {
        ...
        details: [
          "Architected and implemented a modular multi-provider webhook system with signature validation, authentication, idempotent processing, and structured error handling for reliable real-time event processing.",
          "Built and maintained a role-based administrative dashboard with approval workflows, activity monitoring, audit logging, reporting, user management, and configurable operational settings.",
          "Developed secure user-facing portal features for authentication, account management, activity tracking, transaction visibility, and third-party service integration.",
          "Designed and optimized relational database schemas with strong data integrity, transactional consistency, indexing strategy, and maintainability for high-traffic usage.",
          "Applied clean architecture practices across PHP 8 and CodeIgniter 4 codebases, including MVC, service layer, repository, factory, guard, and reusable helper patterns.",
          "Integrated with 10+ third-party REST APIs, implementing request transformation, retries, provider-specific adapters, structured logging, and operational observability.",
        ],
      },
      {
