    ...
    () => [
      {
        ...
        details: [
          "Architected and developed a high-concurrency web platform using CodeIgniter 4 (PHP 8).",
          ...
          "Engineered credit & debit workflows with multi-step verification and transaction reconciliation safeguards.",
